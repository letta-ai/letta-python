...
from ...types.agents import tool_modify_approval_params
        ...
        return self._patch(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"requires_approval": requires_approval}, tool_modify_approval_params.ToolModifyApprovalParams
                ),
            ),
            cast_to=AgentState,
        )
...
class ToolsResourceWithRawResponse:
    def __init__(self, tools: ToolsResource) -> None:
        ...
        self.modify_approval = to_raw_response_wrapper(
            tools.modify_approval,
        )
...
class AsyncToolsResourceWithRawResponse:
    def __init__(self, tools: AsyncToolsResource) -> None:
        ...
        self.modify_approval = async_to_raw_response_wrapper(
            tools.modify_approval,
        )
...
class ToolsResourceWithStreamingResponse:
    def __init__(self, tools: ToolsResource) -> None:
        ...
        self.modify_approval = to_streamed_response_wrapper(
            tools.modify_approval,
        )
...
class AsyncToolsResourceWithStreamingResponse:
    def __init__(self, tools: AsyncToolsResource) -> None:
        ...
        self.modify_approval = async_to_streamed_response_wrapper(
            tools.modify_approval,
        )
