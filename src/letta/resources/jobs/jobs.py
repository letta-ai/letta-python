...
class JobsResourceWithRawResponse:
    ...
    def active(self) -> ActiveResourceWithRawResponse:
        return ActiveResourceWithRawResponse(self._jobs.active)
...
class AsyncJobsResourceWithRawResponse:
    ...
    def active(self) -> AsyncActiveResourceWithRawResponse:
        return AsyncActiveResourceWithRawResponse(self._jobs.active)
...
class JobsResourceWithStreamingResponse:
    ...
    def active(self) -> ActiveResourceWithStreamingResponse:
        return ActiveResourceWithStreamingResponse(self._jobs.active)
...
class AsyncJobsResourceWithStreamingResponse:
    ...
    def active(self) -> AsyncActiveResourceWithStreamingResponse:
        return AsyncActiveResourceWithStreamingResponse(self._jobs.active)
