...
from ..types.tool_create_response import ToolCreateResponse
from ..types.tool_update_response import ToolUpdateResponse
...
class ToolsResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        source_code: str,
        update: bool | NotGiven = NOT_GIVEN,
        ...
        terminal: Optional[bool] | NotGiven = NOT_GIVEN,
        ...
        Args:
          ...
          id: The unique identifier of the tool. If this is not provided, it will be
              autogenerated.
          ...
          terminal: Whether the tool is a terminal tool (allow requesting heartbeats).

          body_user_id: The unique identifier of the user associated with the function.
        ...
        return self._post(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"update": update}, tool_create_params.ToolCreateParams),
            ),
        ...
        *,
        ...
        return await self._post(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"update": update}, tool_create_params.ToolCreateParams),
            ),
            cast_to=ToolCreateResponse,
        )
