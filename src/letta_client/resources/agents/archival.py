...
from ...types.agents import archival_list_params, archival_create_params
from ...types.agents.archival_list_response import ArchivalListResponse
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    archival_list_params.ArchivalListParams,
                ),
            ),
            cast_to=ArchivalListResponse,
        )
