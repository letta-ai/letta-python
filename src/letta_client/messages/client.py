...
class MessagesClient:
    ...
    def list_batch_runs(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Run]:
        """
        List all batch runs.
    ...
    def list_batch_results(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/messages/batches/{jsonable_encoder(run_id)}/results",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def retrieve_batch_run(self, run_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Run:
        """
...
class AsyncMessagesClient:
    ...
    async def list_batch_runs(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[Run]:
        """
        List all batch runs.
        ...
        async def main() -> None:
            await client.messages.list_batch_runs()
    ...
    async def create_messages_batch(
        ...
        async def main() -> None:
            await client.messages.create_messages_batch(
                requests=[
                    LettaBatchRequest(
                        messages=[
                            MessageCreate(
    ...
    async def list_batch_results(
        ...
        async def main() -> None:
            await client.messages.list_batch_results(
                run_id="run_id",
            )
    ...
    async def retrieve_batch_run(self, run_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Run:
        """
        Get the status of a batch run.
        ...
        async def main() -> None:
            await client.messages.retrieve_batch_run(
                run_id="run_id",
            )
