...
class TestArchives:
    ...
    def test_method_modify(self, client: Letta) -> None:
        archive = client.archives.modify(
    ...
    def test_raw_response_modify(self, client: Letta) -> None:
        response = client.archives.with_raw_response.modify(
            archive_id="archive-123e4567-e89b-42d3-8456-426614174000",
        )
    ...
    def test_streaming_response_modify(self, client: Letta) -> None:
        with client.archives.with_streaming_response.modify(
            archive_id="archive-123e4567-e89b-42d3-8456-426614174000",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_modify(self, client: Letta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `archive_id` but received ''"):
            client.archives.with_raw_response.modify(
                archive_id="",
            )
...
class TestAsyncArchives:
    ...
    async def test_method_modify(self, async_client: AsyncLetta) -> None:
        archive = await async_client.archives.modify(
            archive_id="archive-123e4567-e89b-42d3-8456-426614174000",
        )
        assert_matches_type(Archive, archive, path=["response"])
    ...
    async def test_raw_response_modify(self, async_client: AsyncLetta) -> None:
        response = await async_client.archives.with_raw_response.modify(
            archive_id="archive-123e4567-e89b-42d3-8456-426614174000",
        )
    ...
    async def test_streaming_response_modify(self, async_client: AsyncLetta) -> None:
        async with async_client.archives.with_streaming_response.modify(
            archive_id="archive-123e4567-e89b-42d3-8456-426614174000",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_modify(self, async_client: AsyncLetta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `archive_id` but received ''"):
            await async_client.archives.with_raw_response.modify(
                archive_id="",
            )
