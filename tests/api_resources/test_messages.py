...
from letta_client.types import MessageRetrieveResponse, MessageListResponse, MessageSearchResponse
...
from letta_client.types import message_list_params
from letta_client.types import message_search_params
...
class TestMessages:
    ...
    def test_streaming_response_search(self, client: Letta) -> None:
        with client.messages.with_streaming_response.search(
            query="query",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
...
class TestAsyncMessages:
    ...
    async def test_streaming_response_search(self, async_client: AsyncLetta) -> None:
        async with async_client.messages.with_streaming_response.search(
            query="query",
        ) as response :
            assert not response.is_closed
            assert response.http_request.headers.get('X-Stainless-Lang') == 'python'
