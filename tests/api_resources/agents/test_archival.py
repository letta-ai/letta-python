...
class TestArchival:
    ...
    def test_method_retrieve(self, client: Letta) -> None:
        archival = client.agents.archival.retrieve(
            agent_id="agent_id",
        )
    ...
    def test_raw_response_retrieve(self, client: Letta) -> None:
        response = client.agents.archival.with_raw_response.retrieve(
            agent_id="agent_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Letta) -> None:
        with client.agents.archival.with_streaming_response.retrieve(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: Letta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.archival.with_raw_response.retrieve(
                agent_id="",
            )
...
class TestAsyncArchival:
    ...
    async def test_method_retrieve(self, async_client: AsyncLetta) -> None:
        archival = await async_client.agents.archival.retrieve(
            agent_id="agent_id",
        )
        assert_matches_type(ArchivalRetrieveResponse, archival, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLetta) -> None:
        response = await async_client.agents.archival.with_raw_response.retrieve(
            agent_id="agent_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLetta) -> None:
        async with async_client.agents.archival.with_streaming_response.retrieve(
            agent_id="agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLetta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.archival.with_raw_response.retrieve(
                agent_id="",
            )
