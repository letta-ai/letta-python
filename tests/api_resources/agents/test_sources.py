...
class TestSources:
    ...
    def test_method_retrieve(self, client: Letta) -> None:
        source = client.agents.sources.retrieve(
            "agent_id",
        )
    ...
    def test_raw_response_retrieve(self, client: Letta) -> None:
        response = client.agents.sources.with_raw_response.retrieve(
            "agent_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Letta) -> None:
        with client.agents.sources.with_streaming_response.retrieve(
            "agent_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Letta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            client.agents.sources.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncSources:
    ...
    async def test_method_retrieve(self, async_client: AsyncLetta) -> None:
        source = await async_client.agents.sources.retrieve(
            "agent_id",
        )
        assert_matches_type(SourceRetrieveResponse, source, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncLetta) -> None:
        response = await async_client.agents.sources.with_raw_response.retrieve(
            "agent_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncLetta) -> None:
        async with async_client.agents.sources.with_streaming_response.retrieve(
            "agent_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncLetta) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `agent_id` but received ''"):
            await async_client.agents.sources.with_raw_response.retrieve(
                "",
            )
