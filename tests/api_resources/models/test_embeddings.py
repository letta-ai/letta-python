...
class TestEmbeddings:
    ...
    def test_streaming_response_list(self, client: Letta) -> None:
        with client.models.embeddings.with_streaming_response.list() as response:
...
class TestAsyncEmbeddings:
    ...
    async def test_raw_response_list(self, async_client: AsyncLetta) -> None:
        response = await async_client.models.embeddings.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncLetta) -> None:
        async with async_client.models.embeddings.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
