...
## Messages
<details><summary><code>client.messages.<a href="src/letta_client/messages/client.py">list_batch_runs</a>()</code></summary>
<dl>
<dd>
...
client.messages.list_batch_runs()
...
<details><summary><code>client.messages.<a href="src/letta_client/messages/client.py">create_messages_batch</a>(...)</code></summary>
<dl>
<dd>
...
client.messages.create_messages_batch(
    requests=[
        LettaBatchRequest(
            messages=[
                MessageCreate(
...
<details><summary><code>client.messages.<a href="src/letta_client/messages/client.py">list_batch_results</a>(...)</code></summary>
<dl>
<dd>
...
<details><summary><code>client.messages.<a href="src/letta_client/messages/client.py">retrieve_batch_run</a>(...)</code></summary>
<dl>
<dd>
...
client.messages.retrieve_batch_run(
    run_id="run_id",
)
